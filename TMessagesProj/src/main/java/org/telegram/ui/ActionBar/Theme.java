...
public class Theme {
    ...
    public static final int ACTION_BAR_COLOR = 0xffa52a2a;
    ...
    public static final int ACTION_BAR_PROFILE_COLOR = 0xffa52a2a;
    public static final int ACTION_BAR_PROFILE_SUBTITLE_COLOR = 0xffd7eafa;
    public static final int ACTION_BAR_MAIN_AVATAR_COLOR = 0xffA02A20;
